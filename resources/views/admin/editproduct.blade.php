...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    <form class="form-horizontal" action="{{ url('admin/updateproduct', [$product->id]) }}" method="post"
                            ...
                            <div class="box-body">
                                    ...
                                    <div class="col-sm-4">
                                        <select name="ecat_id" class="form-control select2 end-cat" required>
                                            ...
                                            @foreach ($endlevelcategories as $endlevelcategory)
                                                <option value="{{ $endlevelcategory->ecat_name }}">
                                                    {{ $endlevelcategory->ecat_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="p_old_price" class="form-control"
                                            value="{{ $product->p_old_price }}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="p_current_price" class="form-control"
                                            value="{{ $product->p_current_price }}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select name="color[]" class="form-control select2" multiple="multiple" required>
                                            @foreach ($selectedcolors as $selectedcolor)
                                                <option value="{{ $selectedcolor }}" selected>{{ $selectedcolor }}
                                                </option>
                                            @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4" style="padding-top:4px;">
                                        <img src="{{ asset('storage/productimages/' . $product->p_featured_photo) }}"
                                            alt="" style="width:150px;">
                                        <input type="hidden" name="current_photo"
                                            value="{{ $product->p_featured_photo }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                        ...
                                        <table id="ProductTable" style="width:100%;">
                                            <tbody>
                                                @foreach ($selectedphotos as $selectedphoto)
                                                    <tr>
                                                        <td>
                                                            <img src="{{ asset('storage/productimages/' . $selectedphoto) }}"
                                                                alt="" style="width:150px;margin-bottom:5px;">
                                                        </td>

                                                        <td style="width:28px;">
                                                            <a href="{{ url('admin/deletephoto', [$product->id, $selectedphoto]) }}"
