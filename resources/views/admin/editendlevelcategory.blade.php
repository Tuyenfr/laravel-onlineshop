            ...
            <div class="row">
                <div class="col-md-12">
                    <form class="form-horizontal"
                        action="{{ url('admin/updateendlevelcategory', [$endlevelcategory->id]) }}" method="post">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select name="tcat_id" class="form-control select2 top-cat" required>
                                            <option value="{{ $endlevelcategory->tcat_id }}" selected>
                                                {{ $endlevelcategory->tcat_id }}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select name="mcat_id" class="form-control select2 mid-cat" required>
                                            <option value="{{ $endlevelcategory->mcat_id }}" selected>
                                                {{ $endlevelcategory->mcat_id }}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="ecat_name"
                                            value="{{ $endlevelcategory->ecat_name }}" required>
                                    </div>
                                </div>
                                <div class="form-group">
