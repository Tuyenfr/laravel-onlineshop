                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 item item-product-cat">
                                <div class="inner">
                                    <div class="thumb">
                                        <div class="photo"
                                            style="background-image:url({{ asset('frontend/assets/uploads/product-featured-85.jpg') }});">
                                        </div>
                                        <div class="overlay"></div>
                                    </div>
                                    <div class="text">
                            ...
                            <div class="col-md-4 item item-product-cat">
                                <div class="inner">
                                    <div class="thumb">
                                        <div class="photo"
                                            style="background-image:url({{ asset('frontend/assets/uploads/product-featured-89.jpg') }});">
                                        </div>
                                        <div class="overlay"></div>
                                    </div>
                                    <div class="text">
                            ...
                            <div class="col-md-4 item item-product-cat">
                                <div class="inner">
                                    <div class="thumb">
                                        <div class="photo"
                                            style="background-image:url({{ asset('frontend/assets/uploads/product-featured-83.jpg') }});">
                                        </div>
                                        <div class="overlay"></div>
                                    </div>
                                    <div class="text">
                            ...
                            <div class="col-md-4 item item-product-cat">
                                <div class="inner">
                                    <div class="thumb">
                                        <div class="photo"
                                            style="background-image:url({{ asset('frontend/assets/uploads/product-featured-88.jpg') }});">
                                        </div>
                                        <div class="overlay"></div>
                                    </div>
                                    <div class="text">
