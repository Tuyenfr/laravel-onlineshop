...
@section('content')
    ...
    <div class="page-banner"
        style="background-color:#444;background-image: url({{ asset('frontend/assets/uploads/banner_registration.jpg') }});">
        <div class="inner">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="password" class="form-control" name="cust_password_confirmation"
