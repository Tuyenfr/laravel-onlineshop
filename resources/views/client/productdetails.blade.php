                ...
                <div class="col-md-12">
                    <div class="breadcrumb mb_30">
                        <ul>
                            <li><a href="">Home</a></li>
                            <li>></li>
                            <li><a href="{{ url('productbytopcategory', [$product->tcat_id]) }}">{{ $product->tcat_id }}</a>
                            </li>
                            <li>></li>
                            <li><a
                                    href="{{ url('productbymidcategory', [$product->tcat_id, $product->mcat_id]) }}">{{ $product->mcat_id }}</a>
                            </li>
                            <li>></li>
                            <li><a
                                    href="{{ url('productbyendcategory', [$product->tcat_id, $product->mcat_id, $product->ecat_id]) }}">{{ $product->ecat_id }}</a>
                            </li>
                            <li>></li>
                            ...
                            <div class="col-md-5">
                                <ul class="prod-slider">
                                    <li
                                        ...
                                        <a class="popup"
                                            href="{{ asset('storage/productimages/' . $product->p_featured_photo) }}"></a>
                                    </li>
                                    @foreach ($selectedphotos as $selectedphoto)
                                        <li
                                            style="background-image: url({{ asset('storage/productimages/' . $selectedphoto) }});">
                                            <a class="popup"
                                                href="{{ asset('storage/productimages/' . $selectedphoto) }}"></a>
                                        </li>
                                    @endforeach
                                </ul>
                                <div id="prod-pager">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="p-short-des">
                                    ...
                                    <p
                                        ...
                                        <span id="productTitle" class="a-size-large product-title-word-break"
                                            style="text-rendering: optimizelegibility; word-break: break-word; line-height: 32px !important; font-family: Roboto;">{!! $product->p_short_description !!}</span>
                                    </p>
                                    </p>
                                </div>
                                <form action="{{ url('addproducttocart', [$product->id]) }}" method="post">
                                    ...
                                    <input type="hidden" name="p_featured_photo"
                                        value="{{ asset('storage/productimages/' . $product->p_featured_photo) }}">
                                    <div class="p-quantity">
                                        Quantity <br>
                                        <input type="number" class="input-text qty" step="1" min="1"
                                            max="{{ $product->p_qty }}" name="p_qty" value="1" title="Qty"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="condition" style="margin-top: -30px;">
                                        <p>
                                        <p><span
                                                style="color: rgb(51, 51, 51); font-size: 14px;">{!! $product->p_condition !!}</span><br>
                                        </p>
                                        </p>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="return_policy" style="margin-top: -30px;">
                                        <p>
                                        <p><span
                                                style="margin: 0px; padding: 0px; color: rgb(32, 33, 36); font-family: arial, sans-serif; font-size: 16px;">{!! $product->p_return_policy !!}
                                        </p>
                                        </p>
                                    </div>
