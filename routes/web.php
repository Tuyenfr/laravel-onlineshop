...
Route::get('/productbytopcategory/{id}', [ClientController::class, 'productbytopcategory']);
Route::get('/productbymidcategory/{id}/{mcatid}', [ClientController::class, 'productbymidcategory']);
Route::get('/productbyendcategory/{id}/{mcatid}/{ecatid}', [ClientController::class, 'productbyendcategory']);
